...
app.post('/policies', (req, res) => {
    const { id, amount, insurerName, insuredObjectName } = req.body;
    policies[id] = { amount, insurerName, insuredObjectName };
...
app.post('/claims', (req, res) => {
    const { id, policy_id, amount, claimantName, claimDescription } = req.body;
