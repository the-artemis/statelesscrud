...
app.post('/policies', (req, res) => {
    const { id, amount, insurerName, coverage } = req.body;
    policies[id] = { amount, insurerName, coverage };
...
app.post('/claims', (req, res) => {
    const { id, policy_id, amount, claimantName, claimDescription, evidence} = req.body;
    ...
    claims[id] = { policy_id, amount, claimantName, claimDescription ,evidence};
